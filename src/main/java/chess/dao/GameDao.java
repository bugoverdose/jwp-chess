...
public class GameDao {
    ...
    public void saveOpponent(EncryptedAuthCredentials authCredentials) {
        ...
        Command.execute(() -> jdbcTemplate.update(sql, paramSource))
                .throwOnNonEffected("상대방 플레이어로 참여하는 데 실패하였습니다.");
    }

    public boolean loginAsOwner(EncryptedAuthCredentials authCredentials) {
        final String sql = "SELECT COUNT(*) FROM game WHERE password = :password";
    ...
    public boolean loginAsOpponent(EncryptedAuthCredentials authCredentials) {
        final String sql = "SELECT COUNT(*) FROM game WHERE opponent_password = :password";
